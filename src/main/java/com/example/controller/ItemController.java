...
public class ItemController {
	...
	/* ☆追加箇所：GET通信なので、GetMappingでメソッドを追加する☆ */
	@GetMapping("/edit/{id}")
	public String showEdit(@PathVariable Integer id, @ModelAttribute ItemForm itemForm, Model model) {
	...
	/* 追加箇所：POST通信なので、PostMappingでメソッドを追加する */
	@PostMapping("/edit/{id}")
